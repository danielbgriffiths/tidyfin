...
const plans = [
  ...
  },
  {
    name: 'Budgeteer',
    featured: false,
    price: { Monthly: '$6.99', Annually: '$59.99' },
    description:
    ...
    features: [
      ...
      'Scaled Message Pricing',
      'Daily Encouragement Push Notifications',
    ],
    logomarkClassName: 'fill-gray-300',
  },
  {
    name: 'Budgeteer Pro',
    featured: true,
    price: { Monthly: '$24.99', Annually: '$289.99' },
    description:
      ...
      <Container>
        <div className="mx-auto max-w-2xl text-center">
          ...
          <p className="mt-2 text-lg text-gray-600">
            Whether you are a Dedicated Budgeteer or an out of control Doordasher, we have a plan for you.
          </p>
        </div>
