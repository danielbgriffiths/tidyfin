...
const features = [
  {
    name: 'Budgeting by Incentive',
    description:
      'To hold you accountable when you break your budget we will send a handcrafted message to your message group letting them know how you messed up.',
    icon: DeviceUserIcon,
    screen: InviteScreen,
  },
  {
    name: 'Decision Analytics',
    description: "Over time we can learn a lot together about how you break and make your budget. Create visualizations of your spending habits and see where you're going wrong.",
  ...
  },
  {
    ...
    description:
      'We shame you when you break your budget but we also use positive re-enforcement when you have success.',
        ...
        <div className="px-4 py-6">
          <div className="space-y-4">
            {[
              ...
              { label: 'Estimated cost', value: '$328.00' },
            ].map((item) => (
              <div
                key={item.label}
      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          <h2 className="text-3xl font-medium tracking-tight text-white">
            Every feature a Budgeteer needs.
          </h2>
          <p className="mt-2 text-lg text-gray-400">
            TidyFin was built to give you a little help from your friends (without the need to ask for it).
          </p>
        </div>
      </Container>
